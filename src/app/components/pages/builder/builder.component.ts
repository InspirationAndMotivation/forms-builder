...
import { stylesSheetBtn,
  stylesSheetCheckbox,
  stylesSheetInput,
  stylesSheetTextarea,
  stylesSheetSelect } from '../../../shared/style.sheets';
import { StylePanelComponent } from '../../style-panel/style-panel.component';
import { getGeneralStyle, getStyle } from '../../../store';
import { AddStyleAction } from '../../../store/actions/components-style.actions';
import { valueDefault } from '../../../shared/value.sheets';
import { MatchStyle, ValueInput } from 'src/app/interfaces';
